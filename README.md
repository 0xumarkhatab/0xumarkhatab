...
- NFTs + onchain apps
- Full-stack Web3 (Next.js / Node.js / TS)

### Projects I’m most proud of
- **Virtual Fiat Environment**
  Converting USD pegged assets to synthetic representation of local currency on-chain for instant settlement cross border txs.
  Soon to be public . Keep an eye on [ViFi Labs - X](https://x.com/ViFi_Labs)
- [**RiftLend (Multichain Lending/Borrowing)**](https://github.com/RiftLend/contracts-v1)  
  Unified interest rates across Multi-chain + stress-free lending UX  
