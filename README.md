...
| ------ | ---------------------------- |------------|
| Bug hunter | So far, I've audited 8 protocols(uptill  March 2024)<br/> Found 10+ Criticals , 9+ Highs , 11+ Mediums. <br/> These days i'm learning & securing protocols on immunefi.<br/> Check my journey 👉  | [My Audits ](https://github.com/0xumarkhatab/0xumarkhatab-audits) |
